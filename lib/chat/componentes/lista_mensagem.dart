...
import 'package:nutri/chat/modelos/conversa.dart';
import 'package:nutri/chat/modelos/mensagem.dart';
                              ...
                              itemBuilder: (context, indice){
                                ...
                                return Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(mensagem["texto"],style: TextStyle(color: Colors.black),),
                                  ),
                                );
              ...
              children: [
                ...
                Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.insert_emoticon,color: Colors.black54,),
                          SizedBox(
                            width: 4,
                          ),
                          Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    hintText: "Digite uma mensagem",hintStyle: TextStyle(color: Colors.black54),
